...
class BancoDeDadosArmazenamento implements Armazenamento {
    ...
    public BancoDeDadosArmazenamento() {
        try (Connection conn = ConexaoSQLite.getConexao(); Statement stmt = conn.createStatement()) {
    ...
    public void adicionar(Veiculo veiculo) {
        ...
        try (Connection conn = ConexaoSQLite.getConexao(); PreparedStatement pstmt = conn.prepareStatement(sql)) {
    ...
    public List<Veiculo> listar() {
        ...
        try (Connection conn = ConexaoSQLite.getConexao(); Statement stmt = conn.createStatement(); ResultSet rs = stmt.executeQuery(sql)) {
            while (rs.next()) {
